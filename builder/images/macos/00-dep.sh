...
ffbuild_macbase() {
  ...
  wget https://raw.githubusercontent.com/Homebrew/homebrew-core/8197abd5ad0f893bbc7b99f20cd09b50a4b8f446/Formula/n/nasm.rb
  brew install --build-from-source nasm.rb
  rm nasm.rb
